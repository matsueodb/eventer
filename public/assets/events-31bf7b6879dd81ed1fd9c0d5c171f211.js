  ...
  eventsApp = angular.module('eventsApp', ['ui.bootstrap', 'ngAnimate']).controller('get_events', [
    '$scope', '$http', '$window', function($scope, $http, $window) {
      ...
      makeMarker = function(lat, lng) {
        var icon;
        icon = new google.maps.MarkerImage("/eventer/benkei.png", new google.maps.Size(64, 64), new google.maps.Point(0, 0), new google.maps.Point(32, 32), new google.maps.Size(64, 64));
        if (markerYoshida) {
